...
- **Mejoras de Interfaz**: Botones de contexto dedicados, dropdowns independientes para Modelo, Agente y Modo, selecciones robustas por ID, acceso directo a la configuración específica de la extensión y feedback visual inmediato en las interacciones.
